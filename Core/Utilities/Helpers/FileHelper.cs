...
namespace Core.Utilities.Helpers
{
    public class FileHelper
    {
        ...
        public static IResult Update(string imagePath, IFormFile formFile)
        {
            var fileExist = CheckFileExists(formFile);
            if (fileExist.Message!=null)
            {
            ...
            CheckFileDirectoryExist(_currentFileDirectory+_folderName);
            CreateImageFile(_currentFileDirectory+_folderName+randomName+type,formFile);
        ...
        private static IResult CheckFileTypeValid(string type)
        {
            ...
            {
                return new ErrorResult("Resim türünde dosya ekleyiniz!");
            }
